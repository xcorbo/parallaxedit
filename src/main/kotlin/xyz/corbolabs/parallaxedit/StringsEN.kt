...
object StringsEN {
    ...
    val spkFilterName = "SPK Format"                                        // SPK Format
    val spkFilterSymbol = "*.spk"                                           // SPK Format Symbol
    val pngFilterName = "PNG Format"                                        // PNG Format
    val pngFilterSymbol = "*.png"                                           // PNG Format Symbol
    val genErr = "Something Failed..."                                      // Generic Error
    val layerSymbolCombobox = "Layer "                                      // Layer
}